...
public class Constants
{
    ...
    public static Color OSCILLATING_OUTLINE_ORIGINAL_COLOR = new Color(0.706f, 1f, 0.706f);
    public static Color OSCILLATING_OUTLINE_BLINK_COLOR = new Color(0.9f, 0.9f, 1f);
    public static Color NON_OSCILLATING_OUTLINE_ORIGINAL_COLOR = new Color(0.706f, 0.706f, 1f);
